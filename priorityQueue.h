...
hTree* createNode(u_char byte, int frequency);					//Create a new node
void enqueueNode(pQueue *queue, u_char byte, int frequency);	//Create and add a new node in ascending order
